...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>You found Benn!</title>
        <meta
          name="description"
          content="Just someone who enjoys math, playing poker recreationally, and a bit of coding."
        />
        <link rel="canonical" href="https://findbenn.com"></link>
      </Head>
          ...
          <div className="w-4/5 mt-40">
            <div className="sm:w-full md:w-full lg:w-4/5">
              ...
              >
                ...
                <FourthHeading>
                  &gt; Created an advanced filtering options panel to enable
                  users to sort through questions with a range of criterias
                </FourthHeading>
                <FourthHeading>
            ...
            <div className="sm:w-full md:w-full lg:w-3/5">
              ...
              >
                ...
                <SubHeading>
                  ...
                  only to the most outstanding students who epitomise the
                  spirits of entrepreneurship and innovation for a worthy cause,
                  in honour of the pioneer cohort of VJC.
                </SubHeading>
                ...
                <SubHeading>
                  2nd Place - Gold Award in JC/IP Category
                </SubHeading>
                <FourthHeading>
